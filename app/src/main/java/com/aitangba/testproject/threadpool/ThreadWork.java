...
public abstract class ThreadWork<Params, Progress, Error, Result> {
   ...
   public final boolean isCancelled() {
     ...
     * @see AsyncTask#execute
     */
    protected final ThreadWork<Params, Progress, Error, Result> executeSerial(Params... params) {
	 ...
	 * @see AsyncTask#execute
	 */
    protected ThreadWork<Params, Progress, Error, Result> executeParallel(boolean cancelPrevious, Params... params) {
	 ...
	 * @see AsyncTask#execute
	 */
    protected ThreadWork<Params, Progress, Error, Result> executeSerial(boolean cancelPrevious, Params... params) {
