...
public class SlidingActivityHelper {
	...
	/**
	 * Sets mSlidingMenu as a newly inflated SlidingMenuActivity. Should be called within the activitiy's onCreate()
	 *
	...
	/**
	 * Further SlidingMenuActivity initialization. Should be called within the activitiy's onPostCreate()
	 *
	 * @param savedInstanceState the saved instance state (unused)
	 */
	 ...
	 *
	 * @param slidingActionBarEnabled True if you want the ActionBar to slide along with the SlidingMenuActivity,
	...
	/**
	 * Gets the SlidingMenuActivity associated with this activity.
	 *
	 * @return the SlidingMenuActivity associated with this activity.
	 */
	...
	/**
	 * Close the SlidingMenuActivity and show the content view.
	 */
	...
	/**
	 * Open the SlidingMenuActivity and show the menu view.
	 */
	...
	/**
	 * Open the SlidingMenuActivity and show the secondary menu view. Will default to the regular menu
