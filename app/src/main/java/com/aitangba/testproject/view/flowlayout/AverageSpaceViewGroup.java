...
public class AverageSpaceViewGroup extends LinearLayout {

    public AverageSpaceViewGroup(Context context) {
        super(context);
    }

    public AverageSpaceViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AverageSpaceViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
