...
public abstract class BaseSwipeBackActivity extends AppCompatActivity implements SlidingMenu.OnOpenedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int colors[] = {Color.parseColor("#00000000"), Color.parseColor("#11000000") , Color.parseColor("#33000000")};//分别为开始颜色，中间夜色，结束颜色

        GradientDrawable gd = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, colors);
        mSlidingMenu.setShadowDrawable(gd);//setShadowDrawable(R.drawable.slide_shadow);
//        mSlidingMenu.setShadowDrawable(R.drawable.slide_shadow);
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        return mHelper.onKeyUp(keyCode, event) || super.onKeyUp(keyCode, event);
    }
