...
public class CustomViewGroup extends FrameLayout implements NestedScrollingParent {
    ...
    public void onNestedPreScroll(@NonNull View target, int dx, int dy, @NonNull int[] consumed){
        ...
        MarginLayoutParams layoutParams = (MarginLayoutParams) scrollView.getLayoutParams();
        if(dy > 0) { // 上拉
            if(layoutParams.topMargin > minTopMargin && layoutParams.topMargin <= maxTopMargin) {
            ...
            if(layoutParams.topMargin >= minTopMargin && layoutParams.topMargin < maxTopMargin){
                layoutParams.topMargin -= dy;
                layoutParams.topMargin = Math.min(maxTopMargin, layoutParams.topMargin);
                scrollView.requestLayout();
                consumed[1] = dy;
            } else {
